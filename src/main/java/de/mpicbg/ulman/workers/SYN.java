...
public class SYN
{
	...
	public SYN(final LogService _log)
	{
	...
	// ----------- the SYN essentially starts here -----------
	//auxiliary data:
	 ...
	 *
	 * This is the main SYN calculator.
	 */
	...
	throws IOException, ImgIOException
	{
		...
		//go over all FG objects and calc their SYNs
		long noFGs = 0;
		...
		if (noFGs > 0)
		{
			...
			log.info("SYN: Couldn't calculate average SYN because there are no cells labelled.");

		return (syn);
	}

	/// This is the wrapper SYN calculator, assuring complete re-calculation.
	public byte calculate(final String imgPath, final double[] resolution,
	                      final String annPath)
	throws IOException, ImgIOException
	{
